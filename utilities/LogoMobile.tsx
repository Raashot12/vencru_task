...
const LogoMobile = () => (
  ...
  >
    <g filter="url(#filter0_dd_2646_23913)">
      <g clipPath="url(#clip0_2646_23913)">
        ...
        <rect
          ...
          height={32}
          rx={8}
          fill="url(#paint0_linear_2646_23913)"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        <path d="M24.2815 2.5H24.3592V34.5H24.2815V2.5Z" fill="#D0D5DD" />
        ...
        <path
          ...
          fill="#D0D5DD"
        />
        <g filter="url(#filter1_dd_2646_23913)">
          <circle
            cx={19}
            cy={18.5}
            r={8}
            fill="url(#paint1_linear_2646_23913)"
          />
        </g>
        <g filter="url(#filter2_b_2646_23913)">
          <path
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_2646_23913"
        />
        <feColorMatrix
          in="SourceAlpha"
          type="matrix"
        ...
        <feBlend
          mode="normal"
          in2="effect1_dropShadow_2646_23913"
          result="effect2_dropShadow_2646_23913"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect2_dropShadow_2646_23913"
          result="shape"
        />
      </filter>
      <filter
        id="filter1_dd_2646_23913"
        x={8}
        y={8.5}
        width={22}
        height={22}
      ...
      >
        ...
        <feComposite
          in2="SourceAlpha"
          operator="in"
          result="effect1_backgroundBlur_2646_23913"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_backgroundBlur_2646_23913"
          result="shape"
        />
      </filter>
      <linearGradient
        id="paint0_linear_2646_23913"
        x1={19}
        y1={2.5}
        x2={19}
        y2={34.5}
